...
if __name__ == "__main__":
    ...
    for i in range(TRIALS):
      ...
      #  timeHelper.sleep(1.0)
        ...
        allcfs.startTrajectory(3, timescale=TIMESCALE)
        timeHelper.sleep(traj_circle1.duration * TIMESCALE + 1.0)
        ...
        # timeHelper.sleep(1.0)
        # cf0.uploadTrajectory(3, 0, trajE1)
        # cf1.uploadTrajectory(3, 0, trajE2)
        # cf2.uploadTrajectory(3, 0, trajE3)
        # cf3.uploadTrajectory(3, 0, trajE4)
        # cf4.uploadTrajectory(3, 0, trajE5)
        # cf5.uploadTrajectory(3, 0, trajE6)
        # cf6.uploadTrajectory(3, 0, trajE7)
        # # timeHelper.sleep(1.0) 
        # allcfs.startTrajectory(3, timescale=TIMESCALE)
