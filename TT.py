...
pos_U = np.array([[-0.7,0,1.7],[0.7,0,1.7],[-0.6,-0.2,0.9],[0.6,-0.2,0.9],[-0.3,-0.4,0.2],[0.3,-0.4,0.2]])
...
if __name__ == "__main__":
    ...
    traj_circle1 = uav_trajectory.Trajectory()
    traj_circle2 = uav_trajectory.Trajectory()
    traj_circle3 = uav_trajectory.Trajectory()
    traj_circle4 = uav_trajectory.Trajectory()
    traj_circle5 = uav_trajectory.Trajectory()
    traj_circle6 = uav_trajectory.Trajectory()
    traj_circle1.loadcsv("circle_U_1.csv")
    traj_circle2.loadcsv("circle_U_2.csv")
    traj_circle3.loadcsv("circle_U_3.csv")
    traj_circle4.loadcsv("circle_U_4.csv")
    traj_circle5.loadcsv("circle_U_5.csv")
    traj_circle6.loadcsv("circle_U_6.csv")
    ...
    for i in range(TRIALS):
        ...
        cf5.goTo(pos_T[5,:]+np.array([0,0,Z]), 0, 1.0)
        timeHelper.sleep(1.0) 
        cf0.uploadTrajectory(2, 0, trajU1)
        cf1.uploadTrajectory(2, 0, trajU2)
        cf2.uploadTrajectory(2, 0, trajU3)
        cf3.uploadTrajectory(2, 0, trajU4)
        cf4.uploadTrajectory(2, 0, trajU5)
        cf5.uploadTrajectory(2, 0, trajU6)
      #  timeHelper.sleep(1.0)
        allcfs.startTrajectory(2, timescale=TIMESCALE)
        timeHelper.sleep(trajU1.duration * TIMESCALE)
        ...
        timeHelper.sleep(1.0) 
        cf0.uploadTrajectory(3, 0, traj_circle1)
        cf1.uploadTrajectory(3, 0, traj_circle2)
        cf2.uploadTrajectory(3, 0, traj_circle3)
        cf3.uploadTrajectory(3, 0, traj_circle4)
        cf4.uploadTrajectory(3, 0, traj_circle5)
        cf5.uploadTrajectory(3, 0, traj_circle6)
        allcfs.startTrajectory(3, timescale=TIMESCALE*0.5)
        timeHelper.sleep(traj_circle1.duration * TIMESCALE*0.5 + 1.0)
        ...
        timeHelper.sleep(1.0)
        cf0.uploadTrajectory(4, 0, trajE1)
        cf1.uploadTrajectory(4, 0, trajE2)
        cf2.uploadTrajectory(4, 0, trajE3)
        cf3.uploadTrajectory(4, 0, trajE4)
        cf4.uploadTrajectory(4, 0, trajE5)
        cf5.uploadTrajectory(4, 0, trajE6)
        cf6.uploadTrajectory(4, 0, trajE7)
        # timeHelper.sleep(1.0) 
        allcfs.startTrajectory(4, timescale=TIMESCALE)
