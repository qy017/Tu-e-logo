...
zlim([0,1.8]);
for i=1:1:6
    waypoints_orientation(:,:,i)=zeros(size(traj_T,1),3);
end
...
for i=1:1:6
    waypoints(:,:,i)=[traj_U(:,:,i),waypoints_orientation(:,:,i)].';
end
...
Create_coefficients_table(Coeffients1,'U_1.csv');
...
Create_coefficients_table(Coeffients2,'U_2.csv');
...
Create_coefficients_table(Coeffients3,'U_3.csv');
...
Create_coefficients_table(Coeffients4,'U_4.csv');
...
Create_coefficients_table(Coeffients5,'U_5.csv');
...
Create_coefficients_table(Coeffients6,'U_6.csv');
