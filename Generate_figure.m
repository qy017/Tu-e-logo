...
initial_pos = [
    ...
    -0.5,-1,0;
    0.5,-1,0];
mid1 = [(T(1,1)+initial_pos(1,1))/2, (T(1,2)+initial_pos(1,2))/2, (T(1,3)+initial_pos(1,3))/2];
mid2 = [(T(2,1)+initial_pos(2,1))/2, (T(2,2)+initial_pos(2,2))/2, (T(2,3)+initial_pos(2,3))/2];
mid3 = [(T(3,1)+initial_pos(3,1))/2, (T(3,2)+initial_pos(3,2))/2, (T(3,3)+initial_pos(3,3))/2];
mid4 = [(T(4,1)+initial_pos(4,1))/2, (T(4,2)+initial_pos(4,2))/2, (T(4,3)+initial_pos(4,3))/2];
mid5 = [(T(5,1)+initial_pos(5,1))/2, (T(5,2)+initial_pos(5,2))/2, (T(5,3)+initial_pos(5,3))/2];
mid6 = [(T(6,1)+initial_pos(6,1))/2, (T(6,2)+initial_pos(6,2))/2, (T(6,3)+initial_pos(6,3))/2];

traj_T1 = [initial_pos(1,:);mid1; T(1,:)];
traj_T2 = [initial_pos(2,:);mid2;T(2,:)];
traj_T3 = [initial_pos(3,:);mid3;T(3,:)];
traj_T4 = [initial_pos(4,:);mid4;T(4,:)];
traj_T5 = [initial_pos(5,:);mid5;T(5,:)];
traj_T6 = [initial_pos(6,:);mid6;T(6,:)];
% figure(1);
% plot3(T(:,1),T(:,2),T(:,3),'*');
% hold on;
% plot3(U(:,1),U(:,2),U(:,3),'*');
...
% plot3(traj_T1(:,1),traj_T1(:,2),traj_T1(:,3),'r*-');

grid on

%% Save coefficients
% fid = fopen( 'T_1.csv', 'w' );
Coeffients1=[duration_time(1:end-1).',position_coefficients_x1,position_coefficients_y1,position_coefficients_z1,orientation_coefficients_yaw1];
Create_coefficients_table(Coeffients1,'T_1.csv');

Coeffients2=[duration_time(1:end-1).',position_coefficients_x2,position_coefficients_y2,position_coefficients_z2,orientation_coefficients_yaw2];
Create_coefficients_table(Coeffients2,'T_2.csv');

Coeffients3=[duration_time(1:end-1).',position_coefficients_x3,position_coefficients_y3,position_coefficients_z3,orientation_coefficients_yaw3];
Create_coefficients_table(Coeffients3,'T_3.csv');

Coeffients4=[duration_time(1:end-1).',position_coefficients_x4,position_coefficients_y4,position_coefficients_z4,orientation_coefficients_yaw4];
Create_coefficients_table(Coeffients4,'T_4.csv');

Coeffients5=[duration_time(1:end-1).',position_coefficients_x5,position_coefficients_y5,position_coefficients_z5,orientation_coefficients_yaw5];
Create_coefficients_table(Coeffients5,'T_5.csv');

Coeffients6=[duration_time(1:end-1).',position_coefficients_x6,position_coefficients_y6,position_coefficients_z6,orientation_coefficients_yaw6];
Create_coefficients_table(Coeffients6,'T_6.csv');
